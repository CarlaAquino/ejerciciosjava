...
public class magico {
    ...
    public static void main(String[] args) {
        ...
        if (suma_primer_fila != suma_diagonal_1 || suma_primer_fila != suma_diagonal_2 || suma_primer_fila != (suma_fila / n) || suma_primer_fila != (suma_columna / n)) {
            ...
            System.out.println(suma_diagonal_1);
            System.out.println(suma_diagonal_2);
            System.out.println(suma_primer_fila);
            System.out.println(suma_fila / n);
            System.out.println(suma_columna / n);
